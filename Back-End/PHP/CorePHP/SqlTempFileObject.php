...
// SPLTEMPFILEOBJECT can be used to generate temporary files
// it is handy to make a download file because it automatically handles memory
// and deletes the files after the download
...
if (isset($_POST['download'])) {
    ...
    $tempFile->fputcsv($titles);
    foreach ($rates as $currency) {
        $tempFile->fputcsv($currency);
    }
    $tempFile->rewind();
